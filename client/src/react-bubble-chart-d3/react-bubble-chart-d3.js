/**
 * Source: https://github.com/weknowinc/react-bubble-chart-d3
 * Slightly modified code from unmaintained package
 * Modifications: 
 *  - fix deprecated React.FindDOMNdoe warning
 */
...
export default class BubbleChart extends Component {
  ...
  render() {
    ...
    return (
      <svg viewBox="0 0 1000 1000" preserveAspectRatio="xMinYMax" ref={this.svg} className={className} />
    )
  }
  ...
  renderBubbles(width, nodes, color) {
    ...
    const tooltip = d3.select(this.svg.current)
      .append("div")
      .style("opacity", 0)
      .attr("class", "tooltip")
